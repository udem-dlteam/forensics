...
amas = [ 6023600.0, 408523.5, 328900.5, 3098710.0, 1047.355, 3498.5, 22869.0, 19314.0 ]
...
kp = [ [ 69613.0,  75645.0, 88306.0, 59899.0, 15746.0, 71087.0, 142173.0,  3086.0,    0.0 ],
...
ca = [ [       4.0,    -13.0,    11.0,    -9.0,    -9.0,    -3.0,    -1.0,     4.0,    0.0 ],
...
sa = [ [     -29.0,    -1.0,     9.0,     6.0,    -6.0,     5.0,     4.0,     0.0,    0.0 ],
...
kq = [ [  3086.0, 15746.0, 69613.0, 59899.0, 75645.0, 88306.0, 12661.0, 2658.0,  0.0,   0.0 ],
...
cl = [ [      21.0,   -95.0, -157.0,   41.0,   -5.0,   42.0,   23.0,   30.0,     0.0,    0.0 ],
...
sl = [ [   -342.0,   136.0,  -23.0,   62.0,   66.0,  -52.0,  -33.0,   17.0,     0.0,    0.0 ],
...
def almabench( TEST_LOOPS ):
    i=None
    n=None
    p=None
    jd = [ None, None ]
    pv = [ [ None, None, None ], [ None, None, None ] ]
    ...
    PrintDoubleArray( position, 3 )
    PrintDoubleArray( jd, 2 )
    PrintDoubleMatrix( pv )
